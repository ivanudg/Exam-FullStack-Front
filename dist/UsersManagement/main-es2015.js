...
const APP_ROUTES = _angular_router__WEBPACK_IMPORTED_MODULE_0__["RouterModule"].forRoot(routes, { useHash: true });
...
let AgregarEmpleadoComponent = class AgregarEmpleadoComponent {
    constructor(_usuariosService, router) {
...
AgregarEmpleadoComponent.ctorParameters = () => [
...
let EditarEmpleadoComponent = class EditarEmpleadoComponent {
    constructor(activatedRoute, _usuariosService) {
    ...
    obtenerUser(id) {
        this._usuariosService.getUser(id).subscribe((resp) => {
...
EditarEmpleadoComponent.ctorParameters = () => [
...
let ListaEmpleadosComponent = class ListaEmpleadosComponent {
    constructor(router, _usuariosService) {
        this.router = router;
        this._usuariosService = _usuariosService;
        this.usuarios = [];
    }
    ...
    cargarUsuarios() {
        this._usuariosService.getUsers().subscribe((usuarios) => {
...
ListaEmpleadosComponent.ctorParameters = () => [
...
let UsuariosService = class UsuariosService {
    ...
    getUser(id) {
        ...
        const paramId = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]().set('id', id);
